...
import { IDetalleComprobante,DetalleComprobante,IIva2} from '../../../shared/interfaces';

@Component({
	moduleId: module.id,
    selector: 'datos-cabecera',
    templateUrl: './datos-cabecera.html',
...
export class DatosCabeceraComponent  {
    ...
    private placeholder: string = 'Selecciona fecha';
    private selector: number = 0;
    private moneda:number=1;
